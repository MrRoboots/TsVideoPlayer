...
public class HttpProxyCacheServer {
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            HttpProxyCacheDebugger.printfLog("Proxy cache server started. Is it alive? " + isAlive());
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                HttpProxyCacheDebugger.printfWarning("Error registering cache listener", e.getMessage());
            }
        }
    }
    ...
    public void shutdown() {
        HttpProxyCacheDebugger.printfLog("Shutdown proxy server");
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            HttpProxyCacheDebugger.printfError("Error touching file " + cacheFile, e);
        }
    }
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            HttpProxyCacheDebugger.printfLog("Opened connections: " + getClientsCount());
        }
    }
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            HttpProxyCacheDebugger.printfWarning("Failed to close socket on proxy side: {}. It seems client have already closed connection.", e.getMessage());
        }
    }
    ...
    private void onError(Throwable e) {
        HttpProxyCacheDebugger.printfError("HttpProxyCacheServer error", e.getMessage());
    }
