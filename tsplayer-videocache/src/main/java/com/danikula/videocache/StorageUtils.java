...
public class StorageUtils {
    ...
    private static File getCacheDirectory(Context context, boolean preferExternal) {
        ...
        if (appCacheDir == null) {
            ...
            HttpProxyCacheDebugger.printfWarning("Can't define system cache directory! '" + cacheDirPath + "%s' will be used.");
    ...
    private static File getExternalCacheDir(Context context) {
        ...
        if (!appCacheDir.exists()) {
            if (!appCacheDir.mkdirs()) {
                HttpProxyCacheDebugger.printfWarning("Unable to create external cache directory");
                return null;
            }
        }
        return appCacheDir;
