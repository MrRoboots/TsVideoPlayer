...
public class HttpUrlSource implements Source {
    ...
    public void close() throws ProxyCacheException {
        if (connection != null) {
            try {
                ...
                HttpProxyCacheDebugger.printfError("Error closing connection correctly. Should happen only on Android L. " +
    ...
    private void fetchContentInfo() throws ProxyCacheException {
        ...
        try {
            ...
            HttpProxyCacheDebugger.printfError("Error fetching info from " + sourceInfo.url, e);
        } finally {
        ...
        do {
            ...
            if (offset > 0) {
                if (offset > Integer.MAX_VALUE) {
                    ...
                    long ofr = offset;
                    if (ofs.contains(".")) {
                        ofr = Long.parseLong(ofs.substring(0, ofs.indexOf(".")));
                    }
    ...
    private void injectCustomHeaders(HttpURLConnection connection, String url) {
        ...
        HttpProxyCacheDebugger.printfError("****** injectCustomHeaders ****** :" + extraHeaders.size());
