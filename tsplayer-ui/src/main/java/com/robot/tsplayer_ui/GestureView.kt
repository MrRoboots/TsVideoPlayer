...
class GestureView : FrameLayout, IGestureComponent {
    ...
    private lateinit var mProgressPercent: ProgressBar
    private lateinit var mTextPercent: TextView

    private lateinit var mCenterContainer: LinearLayout
