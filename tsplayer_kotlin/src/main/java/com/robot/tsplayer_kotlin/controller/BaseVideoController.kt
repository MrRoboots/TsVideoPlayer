...
abstract class BaseVideoController : FrameLayout, IVideoController, OrientationHelper.OrientationChangeListener {
     ...
     */
    @CallSuper
    private fun onPlayerStateChange(playerState: Int) {
        when (playerState) {
     ...
     * 视图显示状态回调
     */
    private fun onVisibilityChanged(mShowing: Boolean, anim: Animation) {
     ...
     * 进度更新回调
     */
    private fun setProgress(currentPosition: Int, duration: Int) {
